...
CREATE TABLE `product` (
  ...
  CONSTRAINT `product_ibfk_1` FOREIGN KEY (`sales_channel_id`) REFERENCES `saleschannel` (`sales_channel_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `saleschannel` (
  `sales_channel_id` int NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2023-12-18 12:23:10
